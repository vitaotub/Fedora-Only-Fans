...
| **7** | 🎬 Produção Multimídia | Instalação do OBS Studio (Flatpak), ativação de câmera virtual e instalação do EasyEffects |
...
Encontrou um bug? Abra uma issue no GitHub: [Issues do Projeto](https://github.com/vitaotek/Fedora-Only-Fans/issues)
